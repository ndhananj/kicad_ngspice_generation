\begin{circuitikz}[american voltages,scale=1,transform shape]
  \draw (8.38,-7.75) to[R,l={\MixedSigReadableValueLabel{R1}{50}},t={R1}] (9.65,-7.75);
  \draw (13.59,-9.02) to[R,l={\MixedSigReadableValueLabel{R2}{1k}},t={R2}] (13.59,-10.29);
  \draw (11.68,-9.02) to[C,l={\MixedSigReadableValueLabel{C1}{100n}},t={C1}] (11.68,-10.29);
  \draw (11.30,-7.75) to[L,l={\MixedSigReadableValueLabel{L1}{10m}},t={L1}] (12.57,-7.75);
  \draw (5.59,-7.87) to[V,l={\MixedSigReadableValueLabel{V1}{AC 1}},t={V1}] (5.59,-9.40);
